...
Send your location via special clip (📎), located at the bottom left in the chat.
	...
	function location_manager($db,$telegram,$user_id,$chat_id,$location)
		{
			...
			$telegram->sendMessage($content);
				...
				if((bool)$osm_data_dec->node)
				{
					...
					$risposta .="\nMAP: http://www.piersoft.it/daebot/mapdae/index.php?lat=".$lat."&lon=".$lon;
